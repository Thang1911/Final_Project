...
namespace BlazorApi.Migrations
{
    ...
    [Migration("20241214153823_updateName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApi.Models.Category.Proposes", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlazorApi.Models.Scientist.scientist_curriculum_roles", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlazorApi.Models.Scientist.scientist_magazine_role", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlazorApi.Models.Scientist.scientist_offer_role", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlazorApi.Models.Category.LvTopics", b =>
                {
                    b.HasOne("BlazorApi.Models.Category.Categories", "category")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorApi.Models.Offer.Offers", b =>
                {
                    b.HasOne("BlazorApi.Models.Category.Proposes", "Propose")
                        .WithMany("Offers")
            ...
            modelBuilder.Entity("BlazorApi.Models.Scientist.scientist_curriculum_roles", b =>
                {
                    b.HasOne("BlazorApi.Models.Curriculum.Curriculums", "Curriculum")
                        .WithMany("scientist_curriculum_roles")
            ...
            modelBuilder.Entity("BlazorApi.Models.Curriculum.Curriculums", b =>
                {
                    b.Navigation("scientist_curriculum_roles");
                });
